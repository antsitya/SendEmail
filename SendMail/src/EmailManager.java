...
public class EmailManager {
    ...
    public static String username = "antsitya@163.com"; // 服务邮箱(from邮箱)
    public static String password = "shouquanma163"; // 邮箱密码
    public static String senderNick = "智蚁科技";   // 发件人昵称
...
//          mimeMsg.setFrom(new InternetAddress(from));
    ...
    public static void main(String[] args) {
        ...
        String subject = "<h2>哈哈哈</h2>";
        String content = "<strong>你好呀！</strong>";
